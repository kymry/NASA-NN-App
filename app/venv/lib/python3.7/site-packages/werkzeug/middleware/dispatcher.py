...
backend API and a routes written in JavaScript that does the routing
in the browser rather than requesting different pages from the server.
The routes is a single HTML and JS file that should be served for any
path besides "/application".

This example dispatches to an API app under "/application", an admin app
under "/admin", and an app that serves routes files for all other
requests::
